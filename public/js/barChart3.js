function drawBarChartLongDiagonal(){

	var barChartData = [
		
		{ "Pattern": "1", "combination" : "Li_Li ", "energy":-0.433, "mol1":"Li", "mol2":"Li"},
		{ "Pattern": "1", "combination" : "Li_Co ", "energy":0.578, "mol1":"Li", "mol2":"Co"},
		{ "Pattern": "1", "combination" : "Li_Ni ", "energy":-0.144, "mol1":"Li", "mol2":"Ni"},
		{ "Pattern": "1", "combination" : "Co_Co ", "energy":0.578, "mol1":"Co", "mol2":"Co"},
		{ "Pattern": "1", "combination" : "Co_Ni ", "energy":-0.165, "mol1":"Co", "mol2":"Ni"},
...
var barChartGroup =  d3.select("#mainSvg")
  					 ...
  					 .attr("transform","translate(1530,450)");
...
barChartGroup.selectAll(".bar")
   ...
   .attr("class", function(d,i){
	   return "bar bar_longDiagonal " + "bar_longDiagonal_" + d.mol1 + "_" + d.mol2 + " bar_longDiagonal_" + d.mol2 + "_" + d.mol1 ;
   })
