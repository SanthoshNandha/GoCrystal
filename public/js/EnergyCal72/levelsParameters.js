...
function generateLevelParams(level){
    ...
    if(currentLevel == MAX_LEVEL){
        ...
        if(currentLevel > MIN_ROW){
            levelParams["gridRow"] = 5 ; // Random between min and current level
        ...
        console.log("totalMolecules", totalMolecules);
        ...
        levelParams["maxCo"] = Math.ceil(max_co);
        levelParams["maxNi"] = Math.ceil(max_ni);
    }
    console.log(levelParams);
}

generateLevelParams(4)